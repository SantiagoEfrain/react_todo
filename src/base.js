...
import { getAuth } from "firebase/auth"; //Add after secret
...
//NOTE:the code below should remind you to connent authentication from firebase to an OAuth app in github
const auth = getAuth(app);

export {auth} //we export auth so we can use this object  contect (AuthContext)